...
# Docker's auto-generated image tag `${COMPOSE_PROJECT_NAME}-bridge` is a valid
# OCI reference (no `_-` consecutive separators). 1–30 chars total.
_PREFIX_RE = re.compile(r"^[a-z]([a-z0-9_]{0,28}[a-z0-9])?$")
